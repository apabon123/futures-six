# Legacy TSMOM Strategy Implementation Summary

## ⚠️ Legacy Implementation

**This document describes the legacy `TSMOM` class (`src/agents/strat_momentum.py`), which is NOT used in production.**

**Current Production Implementation:**
- **Trend Meta-Sleeve**: See `docs/META_SLEEVES/TREND_IMPLEMENTATION.md` for the current production implementation (`TSMOMMultiHorizon`)
- **Research**: See `docs/META_SLEEVES/TREND_RESEARCH.md` for experimental atomic sleeve ideas

The legacy `TSMOM` class is still available in the codebase but has been superseded by the `TSMOMMultiHorizon` Trend Meta-Sleeve architecture.
...
**Status**: ⚠️ Legacy (superseded by Trend Meta-Sleeve)
